...
![Anaconda Navigator xarray search](C:\Users\ksoenen\Google Drive (ksoenen@whoi.edu)\BCODMO\meetings_workshops\20211026.27_ERRDAP_workshop\GitHub_WorkshopRepo\fig\01-navigator-xarray.png)
...
![Iris search on Anaconda Cloud](C:\Users\ksoenen\Google Drive (ksoenen@whoi.edu)\BCODMO\meetings_workshops\20211026.27_ERRDAP_workshop\GitHub_WorkshopRepo\fig\01-iris-search.png)
...
![Anaconda Navigator conda-forge](C:\Users\ksoenen\Google Drive (ksoenen@whoi.edu)\BCODMO\meetings_workshops\20211026.27_ERRDAP_workshop\GitHub_WorkshopRepo\fig\01-navigator-conda-forge.png)
...
>
> ~~~
> name: pyaos-lessonchannels:  - conda-forge  - defaultsdependencies:  - cartopy=0.16.0=py36h81b52dc_1  - certifi=2018.4.16=py36_0  - cftime=1.0.1=py36h7eb728f_0  - ...
> ~~~
>
> {: .output}
>
...
~~~
$ pythonPython 3.7.1 (default, Dec 14 2018, 13:28:58) [Clang 4.0.1 (tags/RELEASE_401/final)] :: Anaconda, Inc. on darwinType "help", "copyright", "credits" or "license" for more information.>>> print("hello world")hello world>>> exit()$
~~~
...
~~~
$ ipythonPython 3.7.1 (default, Dec 14 2018, 13:28:58) Type 'copyright', 'credits' or 'license' for more informationIPython 7.2.0 -- An enhanced Interactive Python. Type '?' for help.In [1]: print("hello world")                                                    hello worldIn [2]: ls                                                                      data/                              script_template.pyplot_precipitation_climatology.pyIn [3]: exit                                                                    $ 
~~~
...
![Launch Jupyter notebook](C:\Users\ksoenen\Google Drive (ksoenen@whoi.edu)\BCODMO\meetings_workshops\20211026.27_ERRDAP_workshop\GitHub_WorkshopRepo\fig\01-launch-notebook.png)
...
>
> ~~~
> import xarray as xrimport cartopy.crs as ccrsimport matplotlib.pyplot as pltimport numpy as np
> ~~~
>
> {: .language-python}
>
